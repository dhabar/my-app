...
const signin = () => {
  return (
        ...
        />
        <Text className='text-5xl mt-16 font-bold px-3 text-center'>Login</Text>
        ...
        <View>
            <TouchableOpacity className='flex flex-row text-center justify-center items-center border my-4 p-3 mx-4 rounded-md border-gray-300'>
                ...
                <Text className='text-xl font-light ml-3'>Login With Google</Text>
            </TouchableOpacity>
            <TouchableOpacity className='flex flex-row text-center justify-center items-center border p-3 mx-4 rounded-md border-gray-300'>
                ...
                <Text className='text-xl font-light ml-3'>Login With Github</Text>
            </TouchableOpacity>
            <Text className='text-center text-red-500'>Dont have acount ? <Link href={'/signup'}>Signup</Link></Text>
        </View>
